...
insert into CAT1_MONITOR_CONFIG_PROPERTIES(config_id,application,key,label,profile,value) values ('2','monitoring-svc','zuul.routes.stub-svc-1.path','latest','default','/stub1/**');
...
insert into CAT1_MONITOR_CONFIG_PROPERTIES(config_id,application,key,label,profile,value) values ('5','monitoring-svc','zuul.routes.stub-svc-2.url','latest','default','http://localhost:8082');
insert into CAT1_MONITOR_CONFIG_PROPERTIES(config_id,application,key,label,profile,value) values ('6','monitoring-svc','zuul.routes.stub-svc-2.path','latest','default','/stub2/**');
